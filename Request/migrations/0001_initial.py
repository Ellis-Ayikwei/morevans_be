    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stuff_required', models.IntegerField(blank=True, default=0, null=True)),
                ...
                ('service_level', models.CharField(choices=[('standard', 'Standard'), ('express', 'Express'), ('premium', 'Premium')], default='standard', max_length=20)),
